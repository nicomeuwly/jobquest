import { MdArrowDropDown, MdCircle, MdLink } from "react-icons/md"
...
export default function ListItem() {
    ...
    return (
        <div className={"w-full border border-gray-200 px-6 py-4 flex items-center flex-row " + (jobDetails.status == "Réponse négative" ? "bg-white opacity-50" : "bg-white")}>
            ...
            <div className="flex items-center justify-end gap-2 basis-1/6">
            ...
            <a className="basis-1/6 flex justify-end" href={jobDetails.link}><MdLink /></a>
        </div>
    )
}